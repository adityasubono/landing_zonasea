    ...
    (function () {
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var h = {
                            ...
                            Subscribe: {},
                            ViewContent: {}
                        }, i = {agent: !0, automaticmatchingconfig: !0, codeless: !0, tracksingleonly: !0},
        ...
        f.ensureModuleRegistered("SignalsFBEventsBatcher", function () {
            return function (g, i, j, k) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsConfigStore"), b = 1e3, c = 10;
                    ...
                    var i = function () {
                        ...
                        h(a, [{
                            key: "addToBatch", value: function (a) {
                                var b = this;
                            ...
                            key: "forceEndBatch", value: function () {
            ...
            return function (g, i, j, k) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsQE"),
                        ...
                        g = f.getFbeventsModules("SignalsFBEventsTyped"), i = g.coerce, j = g.Typed;
                    ...
                    var k = f.getFbeventsModules("SignalsFBEventsParallelFireConfigTypedef"),
                        ...
                        p = f.getFbeventsModules("signalsFBEventsCoerceAutomaticMatchingConfig"),
                        q = f.getFbeventsModules("signalsFBEventsCoerceInferedEventsConfig"),
                        r = f.getFbeventsModules("SignalsFBEventsLogging"), s = r.logError, t = "global", u = {
                            automaticMatching: p,
                            openbridge: g,
                            batching: o,
                            inferredEvents: q,
                    ...
                    r = function () {
                        ...
                        h(b, [{
                            ...
                            key: "getWithGlobalFallback", value: function (a, b) {
                                var c = t;
                ...
                (function () {
                    ...
                    a = a.objectWithFields({
                        ...
                        dataProcessingState: a.withValidation({
                            def: a.allowNull(a.number()), validators: [function (a) {
            ...
            return function (g, i, j, k) {
                ...
                (function () {
                    ...
                    var a = Object.assign || function (a) {
                        ...
                        d = f.getFbeventsModules("SignalsFBEventsEvents"), e = d.configLoaded,
                    ...
                    var k = f.getFbeventsModules("SignalsFBEventsOptIn"),
                        ...
                        p = f.getFbeventsModules("signalsFBEventsSendEvent"), q = o.each, r = o.keys, s = o.map,
                        t = o.some, u = d.logError, v = d.logUserError, w = {
                            AutomaticMatching: !0,
                    ...
                    d = function () {
                        ...
                        h(d, [{
                            key: "optIn", value: function (a, b) {
                                ...
                                A(b) && (this.optIns.optIn(a, b, d), q([b].concat(m(y[b] || [])), function (a) {
                            ...
                            key: "trackSingleGeneric", value: function (b, c, d, e, f, g) {
            ...
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    function d() {
                        ...
                        var g = f.unsafePixel, h = f.unsafeTarget, j = c(g), k = h instanceof Node ? b(h) : null;
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    function E(a) {
                        ...
                        if (!Object.prototype.hasOwnProperty.call(z, b)) z[b] = !0; else return;
                        b = A(a);
                        w(b);
            ...
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsTelemetry"),
                        b = f.getFbeventsModules("SignalsFBEventsUtils"), c = b.each, d = "fbmq-0.1", e = {
            ...
            return function (g, j, k, l) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsConfigStore"),
                        b = f.getFbeventsModules("SignalsFBEventsEvents"), c = b.pluginLoaded,
                    ...
                    b = function () {
                        ...
                        h(b, [{
                            key: "registerPlugin", value: function (b, d) {
                ...
                (function () {
                    ...
                    function k(a) {
                        ...
                        for (var d = 0; d < a.length; d++) {
                            ...
                            if (c >= l && c < k) {
                                l = j() < f;
                                return {code: h + (l ? "1" : "0"), isInExperimentGroup: l, name: e}
                            }
                        }
                        return null
                    }
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsBatcher"),
                        b = f.getFbeventsModules("SignalsFBEventsLogging"), c = b.logError;
                    b = f.getFbeventsModules("SignalsFBEventsUtils");
                    var d = b.map, e = f.getFbeventsModules("SignalsParamList"),
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var a = f.getFbeventsModules("SignalsFBEventsQE"),
                        ...
                        c = f.getFbeventsModules("SignalsFBEventsExperimentNames"), d = c.SEND_BEACON_STRING_EXPERIMENT;
        ...
        f.ensureModuleRegistered("signalsFBEventsSendEvent", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsEvents"), b = a.fired, c = a.setEventId,
                        d = f.getFbeventsModules("SignalsFBEventsQE"), e = f.getFbeventsModules("SignalsParamList"),
                    ...
                    var q = a.BATCHING_EXPERIMENT, r = a.SEND_BEACON_STRING_EXPERIMENT, s = a.SEND_XHR_EXPERIMENT,
                        t = g.top !== g, u = "SubscribedButtonClick";

                    function v(a) {
                        var b = a.customData, c = a.customParams, f = a.eventName, j = a.id, k = a.piiTranslator,
                            l = a.documentLink, m = a.referrerLink, n = i.href;
                    ...
                    function w(a) {
                        var e = a.customData, f = a.eventName, g = v(a);
                        c.trigger(a.id, g);
                        if (d.isInTest(q)) {
                            j(g);
                            b.trigger("BATCH", g, e);
            ...
            return function (g, h, j, k) {
                ...
                (function () {
                    ...
                    function h() {
                        ...
                        var j = h.pixelID, k = h.extractors, l = g(j), m = Array.isArray(k) ? d(k, e) : null,
            ...
            return function (g, h, i, j) {
                ...
                (function () {
                    ...
                    var e = Math.random(), h = g.fbq && g.fbq._releaseSegment ? g.fbq._releaseSegment : "unknown",
                        i = e < d || h === "canary", j = "https://connect.facebook.net/log/fbevents_telemetry/";
        ...
        f.ensureModuleRegistered("SignalsFBEventsValidateCustomParametersEvent", function () {
            return function (g, h, i, j) {
                ...
                (function () {
                    "use strict";
                    var a = f.getFbeventsModules("SignalsFBEventsBaseEvent"),
                        b = f.getFbeventsModules("SignalsFBEventsTyped"), c = b.coerce, d = b.Typed,
            ...
            return function (a, b, c, d) {
                ...
                (function () {
                    ...
                    var c = f.getFbeventsModules("SignalsFBEventsIWLBootStrapEvent"),
                        ...
                        j = f.getFbeventsModules("signalsFBEventsGetTier"), k = d.logUserError,
    ...
    (function () {
        ...
        f.ensureModuleRegistered("SignalsFBEvents.plugins.opttracking", function () {
            return function (a, b, c, d) {
                ...
                (function () {
                    "use strict";
                    var b = f.getFbeventsModules("SignalsFBEventsEvents"), c = b.getCustomParameters,
                        d = b.piiAutomatched, g = b.piiConflicting, h = b.piiInvalidated,
                    ...
                    var j = f.getFbeventsModules("SignalsFBEventsProxyState"),
                        k = f.getFbeventsModules("SignalsFBEventsUtils"), l = k.some, m = !1;
                    ...
                    k = new b(function (a, b) {
                        ...
                        c.listen(function (c) {
                            ...
                            var g = p(a.disableConfigLoading !== !0, i.CONFIG_LOADING),
                                h = p(n(), i.SUPPORTS_DEFINE_PROPERTY), m = p(o(), i.SUPPORTS_SEND_BEACON),
            ...
            return function (a, b, c, d) {
                ...
                (function () {
                    ...
                    var j = f.getFbeventsModules("SignalsFBEventsNetworkConfig"),
                        k = f.getFbeventsModules("SignalsFBEventsQE"), l = f.getFbeventsModules("SignalsParamList"),
                        ...
                        A = f.getFbeventsModules("SignalsFBEventsTyped"), B = A.coerce, aa = A.Typed, C = n.each;
                    A = n.FBSet;
                    var D = n.isEmptyObject, E = n.isPlainObject, F = n.isNumber, G = n.keys;
                    n = z.execEnd;
                    var H = z.fired, I = z.getCustomParameters, ba = z.iwlBootstrap, J = z.piiInvalidated,
                        ca = z.setIWLExtractors, K = z.validateCustomParameters, L = z.validateUrlParameters,
                        da = o.logError, M = o.logUserError, N = s.global, O = -1, ea = Array.prototype.slice,
                        P = Object.prototype.hasOwnProperty, Q = c.href, R = !1, fa = !1, S = [], T = {}, ga;
                    b.referrer;
                    var U = {PageView: new A(), PixelInitialized: new A()}, V = new q(f, T), W = new x(V, N),
                        ha = new A(["eid"]);
                    ...
                    function ja(a) {
                        ...
                        switch (a) {
                            ...
                            case"trackSingleOnly":
                                var D = c[0], E = c[1], F = B(D, aa["boolean"]()), G = B(E, aa.fbid());
                                if (G == null) {
                                    M({
                                        invalidParamName: "pixel_id",
                                        invalidParamValue: E,
                            ...
                            default:
                                var I = V.pluginConfig.getWithGlobalFallback(null, "dataProcessingOptions"),
                                    J = I != null && I.dataProcessingOptions.includes("LDU"), K = c[0], L = c[1];
                    ...
                    function pa(a, b) {
                        ...
                        try {
                            c.append("ud", a && a.userData || {}, !0), c.append("udff", a && a.userDataFormFields || {}, !0)
                        } catch (b) {
                            J.trigger(a)
                        }
                        ...
                        c.append("coo", b);
                        b = V.pluginConfig.getWithGlobalFallback(a ? a.id : null, "dataProcessingOptions");
                        if (b != null) {
